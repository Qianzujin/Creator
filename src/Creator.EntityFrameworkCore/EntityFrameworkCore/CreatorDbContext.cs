    ...
    ITenantManagementDbContext
{
    ...
    #region MyModule-JobSchedule 工作调度
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(CreatorConsts.DbTablePrefix + "YourEntities", CreatorConsts.DbSchema);
        ...
        builder.Entity<JobInfo>(b =>
           {
               b.ToTable(CreatorConsts.DbTableJobSchedulePrefix + "JobInfo",
                   CreatorConsts.DbSchema);
               b.ConfigureByConvention(); //auto configure for the base class props
