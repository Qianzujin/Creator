...
namespace Creator.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "JobScheduleJobInfo",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobGroup = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    JobDescription = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    JobName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    JobAssemblyName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    JobNamespace = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    JobClassName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    JobStatus = table.Column<byte>(type: "tinyint", nullable: false),
                    CronExpress = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobScheduleJobInfo", x => x.Id);
                });
